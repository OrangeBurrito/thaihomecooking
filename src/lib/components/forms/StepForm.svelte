<script>
  ...
  function nextStep() {
    let section = document.getElementById(`section-${currentForm}`);
    console.log(section);
...
<Form name="booking" method="POST" netlify>
  <section class="form-section" id="section-1" class:shown={currentForm === 1}>
  ...
  <section class="form-section" id="section-2" class:shown={currentForm === 2}>
  ...
  <section class="form-section" id="section-3" class:shown={currentForm === 3}>
  ...
  <section class="form-section" id="section-4" class:shown={currentForm === 4}>
